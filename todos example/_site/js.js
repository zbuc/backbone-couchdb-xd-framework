    ...
    db: function(name, db_opts) {
      ...
      return /** @lends $.couch.db */{
        ...
        view: function(name, options) {
          ...
          // MIGHT want to make pmxdrInterface instead
          // for speed consideration TODO XXX
          pmxdr.request({
            uri: this.uri + "_design/" + name[0] +
      ...
      beforeSend: function(xhr){
        if(ajaxOptions && ajaxOptions.headers){
            for (var header in ajaxOptions.headers){
                xhr.headers = xhr.headers + ";" + header + ": " + ajaxOptions.headers[header];
